...
import { createDocI18n, currentLocale, localize } from "./i18n.js";
import { initLocale, isI18nEnabled, maybeRedirectToDefaultLocale } from "./locale.js";
...
export function initDocChrome(
  ...
  if (footer) {
    createEffect(() => {
      footer.textContent = i18nEnabled
        ? localize(config.footer?.text || "", i18n)
        : String(config.footer?.text || "");
    });
  }
