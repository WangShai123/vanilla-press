...
const DEFAULT_HIGHLIGHT_LANGUAGES_JS = `[
...
export const DEFAULT_CONFIG_JS = `export const docConfig = {
  ...
  runtime: {
    ...
    highlight: {
      enabled: true,
      languages: ${DEFAULT_HIGHLIGHT_LANGUAGES_JS}
    },
    menu: true,
    sidebar: true,
    toc: true,
