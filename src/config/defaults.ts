...
export const DEFAULT_CONFIG_TS = `import type { DocConfig } from '../src/types.ts';
...
export const DEFAULT_LLMS_TS = `import type { LlmsConfig } from '../src/types.ts';
...
export const DEFAULT_MENU_TS = `import type { MenuConfig } from '../src/types.ts';
...
export const DEFAULT_LANGUAGES_TS = `import type { LanguageMessages } from '../src/types.ts';
...
export const DEFAULT_SIDEBAR_TS = `import type { SidebarConfig } from '../src/types.ts';
